...
test('should return entire list', function(assert) {
    ...
    const expected = '<select name="metronome-sound" id="metronome-sound-menu"><option value="../assets/metro-sounds/rimshotshort.wav">rimshot</option><option value="../assets/metro-sounds/880hz 50ms.mp3">880hz</option></select>';
    //Act 
